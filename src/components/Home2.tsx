          ...
          <div className="relative w-full sm:w-4/5 bg-[#70E081] sm:flex flex-col justify-between">
            ...
            <div className="relative z-10 mt-8">
              ...
              <p
                ...
                style={{ fontFamily: "Arial, sans-serif" }}
              >
                TechnoVIT is VIT Chennai&apos;s flagship technical festival,
                where visionary technical clubs converge to push the boundaries
                of innovation and creativity. Over three days, it hosts
                hackathons, robotics battles, workshops, exhibitions and keynote
                talks, drawing over 20,000 participants including students from
                more than 19 countries. TechnoVIT transforms the campus into a
                hub of interdisciplinary collaboration, fostering ideas that
                transcend conventional limits.
              </p>
            </div>
