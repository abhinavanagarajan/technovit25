...
const FilterSection = ({ title, children, isOpen, onToggle }: FilterSectionProps) => (
  <div>
    ...
    onClick={onToggle}
    className={`
        w-full p-5 bg-[#42E25A] border-t-2 border-b-2 border-black
...
const EventFilter = ({ onFilterChange }: EventFilterProps) => {
  ...
  const notifyFilterChange = (updatedState: Partial<FilterState> = {}) => {
    const filters: FilterState = {
      eventType: updatedState.eventType !== undefined ? updatedState.eventType : selectedEventTypes,
      priceRange: updatedState.priceRange !== undefined ? updatedState.priceRange : priceRange,
      freeOfCost: updatedState.freeOfCost !== undefined ? updatedState.freeOfCost : freeOfCost,
      startDate: updatedState.startDate !== undefined ? updatedState.startDate : startDate,
      startTime: updatedState.startTime !== undefined ? updatedState.startTime : startTime,
      endDate: updatedState.endDate !== undefined ? updatedState.endDate : endDate,
      endTime: updatedState.endTime !== undefined ? updatedState.endTime : endTime,
      teamSize: updatedState.teamSize !== undefined ? updatedState.teamSize : selectedTeamSizes
    };
